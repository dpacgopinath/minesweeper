...
**
** Created: Sun Jun 17 21:05:28 2012
...
static const char qt_meta_stringdata_minesweeper[] = {
    "minesweeper\0\0slotHelp()\0newGame()\0"
    "updateTime()\0"
};

const QMetaObject minesweeper::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_minesweeper,
      qt_meta_data_minesweeper, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &minesweeper::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_minesweeper))
